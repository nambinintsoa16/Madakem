				...
				<fieldset class="col-md-12 border bg-white">
					<div class="row">
						...
						<div class="form-group col-md-4">
							...
							<option value="EPZ">LOCAL</option>	
							</select>
						</div>
						<div class="form-group col-md-4">
							<label for="BC_PE" class="titlePO">PE N° : </label>
							<input type="text" name="BC_PE" disabled class="form-control form-control-sm BC_PE" value="<?=$num_po?>M">
						</div>
						...
						<div class="form-group col-md-3">
							<label for="">TYPE DE MATIERE USE : </label>
							<select class="form-control form-control-sm BC_TYPE_MATIERE_USE custom-select" name="BC_TYPEPRODUIT">
				...
				<div class="card-body">
					<div class="form">
						<form>
							...
							<div class="form-group col-md-12 text-left">
							    <label>Prix de Vente en ariary : </label>
