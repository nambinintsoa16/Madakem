...
function service($parametre)
{
	...
	switch ($parametre) {
		case 'COMMERCIAL':
			$designation = "MADAKEM &nbsp; SERVICE COMMERCIAL";
			break;
		case 'COMPTABILITE':
			$designation = "MADAKEM &nbsp; SERVICE COMPTABILITE";
			break;
		case 'PRODUCTION':
			$designation = "MADAKEM &nbsp; SERVICE PRODUCTION";
			break;
		case 'STOCK':
			$designation = "MADAKEM &nbsp; SERVICE STOCK";
			break;
		case 'SURPLUS':
			$designation = "MADAKEM &nbsp; SERVICE SURPLUS";
			break;
		case 'PLANNING':
			$designation = "MADAKEM &nbsp; SERVICE PLANNING";
			break;
		case 'GAINES':
			$designation = "MADAKEM &nbsp; STOCK GAINES";
			break;
		case 'RECYCLAGE':
			$designation = "MADAKEM &nbsp; SERVICE RECYCLAGE";
			break;
		case 'CONTROLLEUR':
			$designation = "MADAKEM &nbsp; CONTROLLEUR";
			break;
		case 'CONTROL_QUALITE':
			$designation = "MADAKEM &nbsp; CONTROL QUALITE";
			break;
		case 'RESPONSABLES_MAGASIN':
			$designation = "PLASMAD &nbsp; RESPONSABLES MAGASIN";
			break;
		case 'TRANSIT':
			$designation = "MADAKEM &nbsp; APPUREMENT";
			break;
		case 'FINANCE':
				$designation = "MADAKEM &nbsp; FINANCE";
			break;	
		case 'SUIVI_COMMERCIALE':
				$designation = "MADAKEM &nbsp; SUIVI COMMERCIAL";
		break;
		default:
			$designation = "";
			break;
...
function type_utilisateur_for_uri($requette)
{
	...
	switch ($requette) {
		...
		case 10:
			...
			break;
		case 11:
			$designation = "Responsables_magasin";
			break;
		case 12:
			$designation = "Transit";
			break;
